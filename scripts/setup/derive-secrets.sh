...
echo ""
echo -e "${BOLD}${GREEN}All secrets re-derived successfully.${RESET}"
echo ""
echo "Next steps:"
echo "  1. Run the setup script to create directories and start the stack:"
echo "     ./scripts/setup/setup-prod.sh --domain <your-domain>"
echo "  2. Or, if directories already exist:"
